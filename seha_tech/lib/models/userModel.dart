...
class UserModel extends Model {
 ...
 set setConsentForResearch( consentForResearch) => this.consentForResearch = consentForResearch;

  get getDateOfDataPrivacyAcceptance => this.dateOfDataPrivacyAcceptance;

 set setDateOfDataPrivacyAcceptance( dateOfDataPrivacyAcceptance) => this.dateOfDataPrivacyAcceptance = dateOfDataPrivacyAcceptance;
 ...
 set setInsuranceCardId( insuranceCardId) => this.insuranceCardId = insuranceCardId;
 ...
 set setPasswordResetCode( passwordResetCode) => this.passwordResetCode = passwordResetCode;

  get getPasswordResetCodeExpiryDate => this.passwordResetCodeExpiryDate;

 set setPasswordResetCodeExpiryDate( passwordResetCodeExpiryDate) => this.passwordResetCodeExpiryDate = passwordResetCodeExpiryDate;
 ...
 set setApprovalOtpExpiryDate( approvalOtpExpiryDate) => this.approvalOtpExpiryDate = approvalOtpExpiryDate;
